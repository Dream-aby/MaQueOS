/*  DO NOT EDIT THIS FILE.
	...
	"/opt/cross-tools/target/usr/include/pthread.h"
...
extern pthread_t pthread_self () __THROW __attribute__ ((__const__));
...
extern int pthread_getconcurrency () __THROW;
...
#ifdef __USE_GNU
extern int pthread_yield () __THROW;
# ifdef __REDIRECT_NTH
extern int __REDIRECT_NTH (pthread_yield, (), sched_yield)
...
extern int pthread_once (pthread_once_t *__once_control,
			 void (*__init_routine) ()) __nonnull ((1, 2));
...
/* Remove a cleanup handler as pthread_cleanup_pop does, but also
   ...
   pthread_cleanup_push_defer was called.  */
#   define pthread_cleanup_pop_restore_np(execute) \
    () pthread_setcanceltype (__clframe.__cancel_type, NULL);	      \
    __clframe.__do_it = (execute);					      \
  } while (0)
#  endif
# endif
...
extern int pthread_atfork (void (*__prepare) (),
			   void (*__parent) (),
			   void (*__child) ()) __THROW;
