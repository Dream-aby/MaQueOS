...
extern int omp_get_num_threads () __GOMP_NOTHROW;
extern int omp_get_max_threads () __GOMP_NOTHROW;
extern int omp_get_thread_num () __GOMP_NOTHROW;
extern int omp_get_num_procs () __GOMP_NOTHROW;

extern int omp_in_parallel () __GOMP_NOTHROW;

extern void omp_set_dynamic (int) __GOMP_NOTHROW;
extern int omp_get_dynamic () __GOMP_NOTHROW;

extern void omp_set_nested (int) __GOMP_NOTHROW __GOMP_DEPRECATED_5_0;
extern int omp_get_nested () __GOMP_NOTHROW __GOMP_DEPRECATED_5_0;
...
extern double omp_get_wtime () __GOMP_NOTHROW;
extern double omp_get_wtick () __GOMP_NOTHROW;

extern void omp_set_schedule (omp_sched_t, int) __GOMP_NOTHROW;
extern void omp_get_schedule (omp_sched_t *, int *) __GOMP_NOTHROW;
extern int omp_get_thread_limit () __GOMP_NOTHROW;
extern void omp_set_max_active_levels (int) __GOMP_NOTHROW;
extern int omp_get_max_active_levels () __GOMP_NOTHROW;
extern int omp_get_supported_active_levels () __GOMP_NOTHROW;
extern int omp_get_level () __GOMP_NOTHROW;
extern int omp_get_ancestor_thread_num (int) __GOMP_NOTHROW;
extern int omp_get_team_size (int) __GOMP_NOTHROW;
extern int omp_get_active_level () __GOMP_NOTHROW;

extern int omp_in_final () __GOMP_NOTHROW;

extern int omp_get_cancellation () __GOMP_NOTHROW;
extern omp_proc_bind_t omp_get_proc_bind () __GOMP_NOTHROW;
extern int omp_get_num_places () __GOMP_NOTHROW;
extern int omp_get_place_num_procs (int) __GOMP_NOTHROW;
extern void omp_get_place_proc_ids (int, int *) __GOMP_NOTHROW;
extern int omp_get_place_num () __GOMP_NOTHROW;
extern int omp_get_partition_num_places () __GOMP_NOTHROW;
extern void omp_get_partition_place_nums (int *) __GOMP_NOTHROW;

extern void omp_set_default_device (int) __GOMP_NOTHROW;
extern int omp_get_default_device () __GOMP_NOTHROW;
extern int omp_get_num_devices () __GOMP_NOTHROW;
extern int omp_get_device_num () __GOMP_NOTHROW;
extern int omp_get_num_teams () __GOMP_NOTHROW;
extern int omp_get_team_num () __GOMP_NOTHROW;

extern int omp_is_initial_device () __GOMP_NOTHROW;
extern int omp_get_initial_device () __GOMP_NOTHROW;
extern int omp_get_max_task_priority () __GOMP_NOTHROW;
...
extern omp_allocator_handle_t omp_get_default_allocator () __GOMP_NOTHROW;
