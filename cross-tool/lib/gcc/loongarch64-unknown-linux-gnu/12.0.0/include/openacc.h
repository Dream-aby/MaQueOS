...
acc_device_t acc_get_device_type () __GOACC_NOTHROW;
...
int acc_async_test_all () __GOACC_NOTHROW;
void acc_wait (int) __GOACC_NOTHROW;
void acc_async_wait (int) __GOACC_NOTHROW;
void acc_wait_async (int, int) __GOACC_NOTHROW;
void acc_wait_all () __GOACC_NOTHROW;
void acc_async_wait_all () __GOACC_NOTHROW;
...
void *acc_get_current_cuda_device () __GOACC_NOTHROW;
void *acc_get_current_cuda_context () __GOACC_NOTHROW;
