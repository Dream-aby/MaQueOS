...
{
  return () __builtin_loongarch_iocsrwr_b ((unsigned char) _1,
					       (unsigned int) _2);
}
...
{
  return () __builtin_loongarch_iocsrwr_h ((unsigned short) _1,
					       (unsigned int) _2);
}
...
{
  return () __builtin_loongarch_iocsrwr_w ((unsigned int) _1,
					       (unsigned int) _2);
}
...
{
  return () __builtin_loongarch_iocsrwr_d ((unsigned long int) _1,
					       (unsigned int) _2);
}
#endif
